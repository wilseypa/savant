...
IIRBase_VariableInterfaceDeclaration::IIRBase_VariableInterfaceDeclaration() {}
IIRBase_VariableInterfaceDeclaration::~IIRBase_VariableInterfaceDeclaration() {}

IIR_Declaration::declaration_type
IIRBase_VariableInterfaceDeclaration::get_declaration_type(){
   return INTERFACE_VARIABLE;
}

void 
IIRBase_VariableInterfaceDeclaration::publish_vhdl_decl(ostream &vhdl_out) {
  vhdl_out << " variable ";
