#ifndef XMLCONCURRENTGENERATEIFSTATEMENT_HH
#define XMLCONCURRENTGENERATEIFSTATEMENT_HH
...
class XMLConcurrentGenerateIfStatement : public virtual IIRBase_ConcurrentGenerateIfStatement, public virtual XMLConcurrentStatement {
public:
  XMLConcurrentGenerateIfStatement();
  ~XMLConcurrentGenerateIfStatement();
