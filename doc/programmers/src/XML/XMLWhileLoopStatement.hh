#ifndef XMLWHILELOOPSTATEMENT_HH
#define XMLWHILELOOPSTATEMENT_HH
...
class XMLWhileLoopStatement : public virtual IIRBase_WhileLoopStatement, public virtual XMLSequentialStatement {
public:
  XMLWhileLoopStatement();
  ~XMLWhileLoopStatement();
