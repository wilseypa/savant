#ifndef XMLPACKAGEDECLARATION_HH
#define XMLPACKAGEDECLARATION_HH
...
class XMLPackageDeclaration : public virtual IIRBase_PackageDeclaration, public virtual XMLLibraryUnit {
public:
  XMLPackageDeclaration();
  ~XMLPackageDeclaration();
