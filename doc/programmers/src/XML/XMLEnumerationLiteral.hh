#ifndef XMLENUMERATIONLITERAL_HH
#define XMLENUMERATIONLITERAL_HH
...
class XMLEnumerationLiteral : public virtual IIRBase_EnumerationLiteral, public virtual XMLDeclaration {
public:
  XMLEnumerationLiteral();
  ~XMLEnumerationLiteral();
