#ifndef XMLGROUPDECLARATION_HH
#define XMLGROUPDECLARATION_HH
...
class XMLGroupDeclaration : public virtual IIRBase_GroupDeclaration, public virtual XMLDeclaration {
public:
  XMLGroupDeclaration();
  ~XMLGroupDeclaration();

  // AIRE function wrappers
  XMLDesignatorList * _get_group_constituent_list();
