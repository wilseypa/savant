#ifndef XMLSUBTYPEDECLARATION_HH
#define XMLSUBTYPEDECLARATION_HH
...
class XMLSubtypeDeclaration : public virtual IIRBase_SubtypeDeclaration, public virtual XMLDeclaration {
public:
  XMLSubtypeDeclaration();
  ~XMLSubtypeDeclaration();
