#ifndef XMLAGGREGATE_HH
#define XMLAGGREGATE_HH
...
class XMLAggregate : public virtual IIRBase_Aggregate, public virtual XMLExpression {
public:
  XMLAggregate();
  ~XMLAggregate();

  // AIRE function wrappers
  XMLAssociationList * _get_element_association_list();
