#ifndef XMLCOMPONENTDECLARATION_HH
#define XMLCOMPONENTDECLARATION_HH
...
class XMLComponentDeclaration : public virtual IIRBase_ComponentDeclaration, public virtual XMLDeclaration {
public:
  XMLComponentDeclaration();
  ~XMLComponentDeclaration();

  // AIRE function wrappers
  XMLGenericList * _get_local_generic_clause();
  XMLPortList * _get_local_port_clause();
