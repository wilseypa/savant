...
XMLComponentInstantiationStatement::XMLComponentInstantiationStatement() {}
XMLComponentInstantiationStatement::~XMLComponentInstantiationStatement() {}

XMLAssociationList *
XMLComponentInstantiationStatement::_get_generic_map_aspect() {
  return dynamic_cast<XMLAssociationList *>(get_generic_map_aspect());
}
XMLAssociationList *
XMLComponentInstantiationStatement::_get_port_map_aspect() {
  return dynamic_cast<XMLAssociationList *>(get_port_map_aspect());
}

void
XMLComponentInstantiationStatement::xmlGeneration(XmlFile &file) {
  if (!bVisited) {
