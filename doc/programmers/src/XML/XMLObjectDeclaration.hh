#ifndef XMLOBJECTDECLARATION_HH
#define XMLOBJECTDECLARATION_HH
...
class XMLObjectDeclaration : public virtual IIRBase_ObjectDeclaration, public virtual XMLDeclaration {
public:
  XMLObjectDeclaration();
  ~XMLObjectDeclaration();
