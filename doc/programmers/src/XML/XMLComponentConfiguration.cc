...
XMLComponentConfiguration::XMLComponentConfiguration() {}
XMLComponentConfiguration::~XMLComponentConfiguration() {}

XMLDesignatorList *
XMLComponentConfiguration::_get_instantiation_list() {
  return dynamic_cast<XMLDesignatorList *>(get_instantiation_list());
}
XMLAssociationList *
XMLComponentConfiguration::_get_generic_map_aspect() {
  return dynamic_cast<XMLAssociationList *>(get_generic_map_aspect());
}
XMLAssociationList *
XMLComponentConfiguration::_get_port_map_aspect() {
  return dynamic_cast<XMLAssociationList *>(get_port_map_aspect());
}

void
XMLComponentConfiguration::xmlGeneration(XmlFile &file) {
  if (!bVisited) {
