...
XMLProcedureCallStatement::XMLProcedureCallStatement() {}
XMLProcedureCallStatement::~XMLProcedureCallStatement() {}

XMLAssociationList *
XMLProcedureCallStatement::_get_actual_parameter_part() {
  return dynamic_cast<XMLAssociationList *>(get_actual_parameter_part());
}

void
XMLProcedureCallStatement::xmlGeneration(XmlFile &file) {
  if (!bVisited) {
