#ifndef XMLNATUREDECLARATION_HH
#define XMLNATUREDECLARATION_HH
...
class XMLNatureDeclaration : public virtual IIRBase_NatureDeclaration, public virtual XMLDeclaration {
public:
  XMLNatureDeclaration();
  ~XMLNatureDeclaration();
